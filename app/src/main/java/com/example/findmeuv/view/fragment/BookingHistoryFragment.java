...
public class BookingHistoryFragment extends Fragment {
    ...
    private void initialize(final View view) {
        ...
        retryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BookingHistoryFragment.this.getFragmentManager().beginTransaction().detach(BookingHistoryFragment.this).attach(BookingHistoryFragment.this).commit();
            }
        });
    ...
    private void getPendingTrip() {
        ...
        param.put("sub", "get_booking_history");
            ...
            public void onChanged(List<Map<String, String>> list) {
                ...
                switch (type) {
                    case "get_pending_book":
                        ...
                        pendingAdapter = new BookingPendingAdapter(pendingBookItem, getContext(), adapterHandler, false);
